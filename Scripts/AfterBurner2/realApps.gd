...
static var isSleepClosed : bool = false


#func _ready() -> void:
	#para = get_tree().get_first_node_in_group("HUD")
@onready var world = World.new()
@onready var para = HUD.new()
...
func _on_mail_opened_pressed() -> void:
	if world.wave==1 or world.wave==2 or world.wave==3 or world.wave==4:
...
func _on_mail_opened_2_pressed() -> void:
	if world.wave==2 or world.wave==3 or world.wave==4:
...
func _on_mail_opened_3_pressed() -> void:
	if world.wave==3 or world.wave==4 :
